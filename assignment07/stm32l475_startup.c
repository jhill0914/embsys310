...
// I don't think you'd want the Systick handler to call Unused_Handler, since it spins forever.  Wouldn't
// that lock up the device if the systick interrupt were enabled?
